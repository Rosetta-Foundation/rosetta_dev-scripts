...
| Slash-style prompts  | `.claude/commands/` (`/review`, `/add-repo`, `/sdlc-status`, `/prd-portfolio`, `/sdlc-run`, `/watch-pr-approve`, `/write-prd`) | Matching `.cursor/rules/command-*.mdc` — ask the agent to follow them                  |
